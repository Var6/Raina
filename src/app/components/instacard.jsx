...
const Instacard = ({links,likes}) => {
  return (

    <div className="bg-gray-100 p-4">
    <div className="bg-white border rounded-sm max-w-md">
    <div className="flex items-center px-4 py-3">
      <Image className="h-8 w-8 rounded-full" src="https://scontent.cdninstagram.com/v/t51.2885-19/460538753_891143436217774_5535561969616032351_n.jpg?stp=dst-jpg_s160x160_tt6&_nc_cat=108&ccb=1-7&_nc_sid=bf7eb4&_nc_ohc=6KcFrXbLxVgQ7kNvgFdo_b_&_nc_zt=24&_nc_ht=scontent.cdninstagram.com&oh=00_AYDuKW5HgJi4Xrm7uUDu7RUkHQdZDaE50BN1BJY9CGx7eQ&oe=675B407D"/>
      <div className="ml-3 ">
        <span className="text-sm font-semibold antialiased block leading-tight">8fact</span>
        <span className="text-gray-600 text-xs block">Lucknow, India</span>
      </div>
    </div>
    <Image src={links} alt='images'/>
